...
import {
    ...
    defaultButtonText,
    dataBlock
} from '../../resource/text/global-message';
    ...
    generateInnerView(innerViewId) {
        ...
        switch (innerViewId) {
            ...
            case 'about':
                ...
                break;
            case 'languageLevel':
                TargetComponent = React.lazy(() => import('../global-message-view/globa-message-view.jsx'));
                finalComponent = <TargetComponent type={globalMessageType.info}
                    buttonText={defaultButtonText.understand}
                    title={dataBlock.d0000.title}
                    text={dataBlock.d0000.text} />
                break;
            default:
                TargetComponent = React.lazy(() => import('../homepage-view/homepage-view.jsx'));
                finalComponent = <TargetComponent />
